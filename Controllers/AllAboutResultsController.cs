    ...
    public class AllAboutResultsController : Controller
    {
        public IActionResult Index()
        {
            ...
            switch (day)
            {
                case "Monday":
                case "Tuesday":
                    HttpContext.Session.SetString("dayMsg","The work wee just started! Stay focused, you have a lot to do this week!");
                    route = 1;
                    break;
                case "Wednesday":
                    HttpContext.Session.SetString("dayMsg","Halway to the weekend!");
                    route = 2;
                    break;
                case "Thursday":
